...
export const mockManifests: ModuleManifest[] = [
  ...
  },
  {
    ...
    dashboard: {
      navigation: { sidebarPriority: 40, sidebarSection: 'Community' },
      homePage: { featured: true, priority: 40 },
      settings: {
        groups: [
          { key: 'general', label: 'General', order: 10 },
  ...
  },
  {
    ...
    dashboard: {
      navigation: { sidebarPriority: 50, sidebarSection: 'Community' },
      homePage: { featured: true, priority: 50 },
      settings: {
        groups: [
          { key: 'general', label: 'General', order: 10 },
  ...
  },
  {
    ...
    dashboard: {
      navigation: { sidebarPriority: 60, sidebarSection: 'Operations' },
      homePage: { featured: true, priority: 60 },
      settings: { groups: [{ key: 'roles', label: 'Roles', order: 10 }] },
    },
    supportsHotReload: false,
  },
  {
...
export const mockSettings: SettingMetadata[] = [
  ...
  },
  {
    ...
    category: 'Welcome',
    type: 'channel',
    defaultValue: '523371374279131156',
    restartRequired: true,
    order: 20,
  },
  {
    ...
    category: 'Welcome',
    type: 'image',
    defaultValue: 'https://example.com/welcome.png',
    restartRequired: true,
    order: 10,
  },
  {
  ...
  },
  {
    ...
    category: 'Goodbye',
    type: 'image',
    defaultValue: 'https://example.com/goodbye.png',
    restartRequired: true,
    order: 10,
  },
  {
  ...
  },
  {
    ...
    category: 'Goodbye',
    type: 'template',
    defaultValue: 'HOPE YOU ENJOYED YOUR STAY',
    restartRequired: true,
    order: 30,
  },
  {
  ...
  },
  {
    ...
    category: 'Moderation',
    type: 'role',
    defaultValue: ['Moderator', 'Hoak Mod', 'Admin', 'Hoak Admin'],
    restartRequired: true,
    multiple: true,
    order: 20,
  },
