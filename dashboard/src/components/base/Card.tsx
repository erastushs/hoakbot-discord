...
const variantClasses: Record<CardVariant, string> = {
  ...
  interactive:
    'border-dashboard-border-subtle bg-dashboard-bg-surface shadow-elevation-1 hover:border-dashboard-border-strong hover:bg-dashboard-bg-surface-elevated hover:shadow-elevation-2 motion-safe:hover:-translate-y-0.5',
...
export function Card({ className, variant = 'standard', ...props }: CardProps) {
  return <div className={cx('rounded-lg border p-5 transition duration-hover ease-dashboard', variantClasses[variant], className)} {...props} />;
}
