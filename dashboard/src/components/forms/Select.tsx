...
export function Select({ className, description, error, id, label, options, ...props }: SelectProps) {
  ...
  return (
    <label className="grid gap-1.5 text-small font-medium text-dashboard-text-primary" htmlFor={selectId}>
