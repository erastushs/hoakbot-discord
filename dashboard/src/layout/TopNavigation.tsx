...
export function TopNavigation({ breadcrumb }: { breadcrumb: BreadcrumbItem[] }) {
  ...
  return (
    <header className="sticky top-0 z-sticky flex h-header items-center border-b border-white/8 bg-dashboard-bg-page/78 px-4 backdrop-blur-2xl tablet:px-6 desktop:px-10">
