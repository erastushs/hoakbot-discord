...
## Status
Accepted for the 4.0.0 implementation plan; supersedes plugin portions of earlier module-loader decisions while retaining compatibility.
...
## Related ADRs
ADR-001 Module Manifest, ADR-007 Plugin System & Module Loading, ADR-010 Configuration Lifecycle, ADR-012 Configuration, ADR-013 Dashboard, ADR-014 Command Discovery.
