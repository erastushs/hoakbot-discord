...
## Testing
API schema snapshots, auth/role/guild/CSRF/CORS/rate-limit matrices, dependency state transitions, audit assertions, metadata fuzzing, setting-type components, optimistic/conflict/error states, navigation ordering, accessibility/responsive/e2e/WebSocket tests, and all quality commands.
